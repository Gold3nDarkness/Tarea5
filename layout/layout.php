    ...
    <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="{$this->directory}Pokemon/add.php">Agregar Pokemon <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="{$this->directory}Races/list.php">Tipos</a>
          </li>
          <li class="nav-item">
          <a class="nav-link" href="{$this->directory}Region/list.php">Regiones</a>
        </li>       
        </ul>   
      </div>
    </nav>
